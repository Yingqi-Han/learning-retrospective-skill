...
![Claude Code demo: second identical structured failure triggers the hook, which injects a reminder; the agent recalls a stored lesson and changes approach](docs/demo.gif)
